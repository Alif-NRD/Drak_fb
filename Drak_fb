...
def args():
    import argparse
    parser = argparse.ArgumentParser(description='Facebook Brute Force Tool by Shadow Hacking aka shadow-sec')
    parser.add_argument('-u', '--user', help='Email or Phone#')
...
╚═╗╠═╣├─┤ │││ ││││╠╣ ╠╩╗├┬┘│ │ │ ├┤ 
╚═╝╩ ╩┴ ┴─┴┘└─┘└┴┘╚  ╚═╝┴└─└─┘ ┴ └─┘v1.0
created by Shadow Hacking (shadow-sec)
▄▄ ▄▄ ▄▄ ▄▄ ▄▄ ▄▄ ▄▄ ▄▄ ▄▄ ▄▄ ▄▄ ▄▄
░░ ░░ ░░ ░░ ░░ ░░ ░░ ░░ ░░ ░░ ░░ ░░

website: Down 4 Maint.
==========================================
""")
    print("")
    ...
    if args and args.single_password:
        ...
        if args and args.password_list:
            ...
            password_file = input(CliColors.OKGREEN+"[?] Password List Filename: \t")
    ...
    if args and args.user:
        ...
        user = input(CliColors.OKGREEN+"[?] Email or Phone#: \t")
    ...
    if flag[0]:
        ...
        _log.write_colored("[-] No Password Found.", 'red')
    print("")
